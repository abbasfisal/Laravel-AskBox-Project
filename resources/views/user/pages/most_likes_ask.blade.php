        ...
        <div class="lg:flex lg:space-x-10">
            ...
            <div class="lg:w-2/3">
                <div class="my-5 flex justify-between pb-3">
                    <h2 class="text-2xl font-semibold"> محبوب ترین ها </h2>
                </div>
                    ...
                    @forelse($asks as $ask)
                        ...
                        <div class="flex lg:flex-row flex-col lg:space-x-4 py-4 relative w-full">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <div class="flex space-x-2 items-center text-sm pt-1 text-sm flex mt-5">
                                    <div> {{$ask->created_at->diffForHumans()}}</div>

                                    <div> <i>{{$ask->user_likes_count }} Likes</i></div>
                                    <div>
                                ...
                                @foreach($ask->categories as $category)
                                    <span
                                        class="bg-blue-100 font-semibold p-1 rounded-full text-blue-500 text-xs m-2">
                                        {{$category->title}}
                                    </span>
                                @endforeach
                            </div>
