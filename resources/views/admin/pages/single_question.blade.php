    ...
    <div class="card lg:w-3/4 p-4 ">
        ...
        <div class="grid grid-flow-col pt-3 -mx-1 -mb-1 font-semibold text-sm">
            <div class="flex items-center p-1.5 rounded-md">
                ...
                <svg
                    class="bg-blue-100 h-9 mr-2 p-1.5 rounded-full text-blue-600 w-9 -my-0.5  lg:block"
    ...
    <div class="lg:flex lg:space-x-10">
        <div class="lg:w-3/4 lg:px-20 space-y-7">
            ...
            <div class="card lg:mx-0 p-4"
                ...
                <div class="flex space-x-3">
                    <img src="{{auth('admin')->user()->image}}" class="w-10 h-10 rounded-full">
                    <input placeholder="What's Your Mind ? {{auth('admin')->user()->name}}!"
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <span>
                                                <i class="uil-heart"></i>
                                                {{$commentItem->users_like_count() .'like' }}
                                            </span>

                                            <a href="#" uk-toggle="target:#show-comment-modal"
                                               onclick="hi('{{route('addreply.admin' , [$commentItem->id  ,$question->id])}}')"
                                            >
                                                Reply
                                            </a>
...
<div id="create-post-modal" class="create-post is-story uk-modal" uk-modal>
    <div
        ...
        <!-- --------------- MODAL INPUT TEXT -------------------- -->
        <form action="{{route('addcomment.admin' , $question->id)}}" method="post">
            @csrf
            @method('post')
            ...
            <div class="flex flex-1 items-start space-x-4 p-5">
                ...
                <textarea
                    ...
                    rows="5" placeholder="What's Your Mind ? {{auth('admin')->user()->name}}!"></textarea>
                </div>
            ...
            <div class="flex flex-1 items-start space-x-4 p-5">
                ...
                <div class="flex-1 pt-2">
                 <textarea
                     ...
                     class="uk-textare text-black shadow-none
                    focus:shadow-none text-xl font-medium resize-none"
                     rows="5" placeholder=" REPLY {{auth('admin')->user()->name}}">
                     {!! $question!!}
                 </textarea>
